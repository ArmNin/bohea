			...
			<div class="content">
				...
				<div class="container-proceso-slider">
					...
					<div class="products-wrapper-shortcode" id="hidenshow">
						...
						<?php echo do_shortcode('[products limit="6" columns="3" orderby="popularity" class="arma-tu-kit"]'); ?>
		...
		<nav class="nav flex-normal">
			...
			<div class="menu flex-normal">
				...
				<div class="left flex-normal">
					...
					<div class="menu-item">
						<a href="<?php echo get_site_url() ?>/shop">Tienda</a></div>	
				...
				<div class="right flex-normal">	
					...
					<div class="menu-item"><a href="<?php echo get_site_url() ?>/arma-tu-kit">Arma tu kit</a></div>
					<div class="menu-item">
