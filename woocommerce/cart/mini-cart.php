	...
	<div class="container-mini-cart-pos flex-normal">
		...
		<div class="info-mini-cart-bottom">
			...
			<div class="total-mini-cart">
				...
				<div class="total-wrap envio-price-container flex-normal">

				    <span class="envio-label label-sub">
				        <?php esc_html_e('Envio', SMCW_TD);  ?>
				    </span>

				    <div class="envio-price-wrap price-sub">
				    ...
				    <?php  
				    	...
				    	if($sub_total < 600){
				    		...
				    		echo '<p class="free-shipping-notice">Para obtener <span>envio gratis</span> agrega más de <span>$600</span> a tu carrito</p>';
